...
/**
 * http://www.lai18.com/content/1091480.html
 *
...
public class Regression {
     ...
     */
    public static double LineRegression(double[][] X,
                                        double[] Y,
                                        double[] K,
                                        int n,
                                        int m) {
     ...
     * @param K          最终回归系数（返回）
     * @param m          样本个数
     * @param retainRate 样本最低保有率
     * @param LossPoint  被丢弃的样本点(返回)
     *
     ...
     */
    public static double avgerror(double[][] X,
                                  double[] Y,
                                  double[] K,
                                  int n,
                                  int m) {
     ...
     */
    public static int maxErrorIndex(double[][] X,
                                    double[] Y,
                                    double[] K,
                                    int n,
                                    int m) {
